...
%As discussed already in previous
...
%With the specific configuration described above, and with a series of other small adjustments not %mentioned here, 
...
%In the next sections, this limit, as well as solutions to increase it, will be discussed. 
...
%This proposal addresses certain aspects of these limitations. The goal is to increase the CMS readout rate to 30 kHz. There are multiple places to improve the throughput. Some of these are interdependent.  Some are in progress, or are planned as part of general CMS Experiment Physics Responsibilities (EPR). These throughput improvements will be discussed below. 
...
%The comprehensive series of tasks needed for overall run preparation are not reported here. 
