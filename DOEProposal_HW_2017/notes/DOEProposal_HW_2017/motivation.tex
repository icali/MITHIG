...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=.49\textwidth]{DJetPlots/fhHistoMass_R0.png}
\includegraphics[width=.49\textwidth]{DJetPlots/fhHistoMass_R2.png}
%\includegraphics[width=.49\textwidth]{DJetPlots/fhHistoMass_R0Scaled.png}
%\includegraphics[width=.49\textwidth]{DJetPlots/fhHistoMass_R2Scaled.png}
\caption{}
\label{fig:D0_Jet}
\end{center}
\end{figure}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=.49\textwidth]{DJetPlots/PrelimYield.png}
%\includegraphics[width=.49\textwidth]{DJetPlots/ProjectionYield.png}
\caption{}
