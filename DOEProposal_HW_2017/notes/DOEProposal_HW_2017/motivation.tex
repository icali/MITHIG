...
These examples illustrate the large improvements in statistical precision afforded by the improved ability to select jet events and high \pt\ particles with L1 trigger rate upgrade during high luminosity Pb-Pb collisions. 
...
%\multicolumn{5}{|c|}{\textbf{Measurements of Current Pixel System and 2018 Pixel System} }\\
 \cline{1-5}
     &   \multicolumn{2}{p{6cm}|}{ \textbf{Current 0.04 $nb^{-1}$ + Present System}}  & \multicolumn{2}{p{6cm}|} {\textbf{2018 Pb-Pb 1 $nb^{-1}$ + Upgraded System}} \\
            \cline{1-5}
\hline
