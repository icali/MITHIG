...
\RCS$Revision: 389681 $
\RCS$Id: notes_for_authors.tex 389681 2017-02-26 21:56:14Z alverson $
...
%  245  KRB5CCNAME=/tmp/krb5cc_cern_1401 kinit alverson@CERN.CH
%  246  ls /tmp/krb5cc*1401
%  251  alias svn="KRB5CCNAME=/tmp/krb5cc_cern_1401 `which svn`"
\texttt{alias svn 'env KRB5CCNAME=/tmp/krb\_cern\_`id -u` svn'} for \texttt{alias svn 'env KRB5CCNAME=/tmp/krb\_cern\_`id -u` svn'} for \texttt{tcsh},\\
\texttt{KRB5CCNAME=/tmp/krb\_cern\_`id -u` kinit user@CERN.CH} 
